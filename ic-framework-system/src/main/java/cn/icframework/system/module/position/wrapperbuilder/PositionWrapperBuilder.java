package cn.icframework.system.module.position.wrapperbuilder;
 ...
 */
@Component
public class PositionWrapperBuilder extends BasicWrapperBuilder<PositionDef> {

    /**
    * 返回一个数据库定义对象
    */
    public PositionWrapperBuilder() {
        super(PositionDef.table());
    }
     ...
     */
    @Override
    protected SqlWrapper list(QueryParams params, PositionDef def) {
     ...
     */
    @Override
    protected QueryField<?> doSort(OrderItem orderItem, PositionDef def) {
     ...
     */
    @Override
    protected List<DefaultOrderBy> defaultSort(PositionDef def) {
         // 使用以下方法构建默认排序
