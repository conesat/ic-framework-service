...
public class Menu implements Serializable {
     ...
     * 菜单名
     */
    @TableField(value = "name", length = 10, comment = "菜单名")
    private String name;

    /**
     * 上级菜单id
     */
    @TableField(value = "parent_id", comment = "上级菜单id")
    private Long parentId;

    /**
     * icon名
     */
    @TableField(value = "icon", length = 50, comment = "icon名")
    private String icon;

    /**
     * icon类型
     */
    @TableField(value = "icon_type", comment = "icon类型")
    private IconType iconType;

    /**
     * 类型
     */
    @TableField(value = "menu_type", comment = "类型")
    private MenuType menuType;

    /**
     * 归属平台类型
     */
    @TableField(value = "menu_platform_type", comment = "归属平台类型")
    private MenuPlatformType menuPlatformType;

    /**
     * 允许分配的用户类型
     */
    @TableField(value = "user_type", notNull = true, comment = "允许分配的用户类型")
     ...
     * 排序号
     */
    @TableField(value = "order_no", comment = "排序号")
    private Integer orderNo;

    /**
     * 路径
     */
    @TableField(value = "path", comment = "路径")
    private String path;

    /**
     * 重定向，访问当前路径会重定向到这个地址
     */
    @TableField(value = "redirect", comment = "重定向")
     ...
     * 否则是文件路径
     */
    @TableField(value = "url", comment = "地址")
    private String url;

    /**
     * 是否隐藏
     */
    @TableField(value = "hidden", comment = "是否隐藏")
    private Boolean hidden;

    /**
     * 是否保持状态
     */
    @TableField(value = "keep_alive", defaultValue = "false", comment = "是否保持状态")
    private Boolean keepAlive;

    /**
     * 层级路径，有系统生成，用于判断层级
     */
    @TableField(value = "parent_path", comment = "层级路径")
    private String parentPath;

    /**
     * 隶属,访问该菜单，会让belong的菜单高亮
     */
    @TableField(value = "belong", comment = "隶属")
    private String belong;

    /**
     * 是否系统
     */
    @TableField(value = "system", comment = "是否系统")
