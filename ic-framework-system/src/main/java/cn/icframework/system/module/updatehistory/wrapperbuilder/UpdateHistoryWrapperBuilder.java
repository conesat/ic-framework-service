package cn.icframework.system.module.updatehistory.wrapperbuilder;

import cn.icframework.mybatis.query.QueryField;
import cn.icframework.system.module.updatehistory.def.UpdateHistoryDef;
 ...
 */
@Component
public class UpdateHistoryWrapperBuilder extends BasicWrapperBuilder<UpdateHistoryDef> {
    ...
    * 返回一个数据库定义对象
    */
    public UpdateHistoryWrapperBuilder() {
        super(UpdateHistoryDef.table());
    }
     ...
     */
    @Override
    protected SqlWrapper list(QueryParams params, UpdateHistoryDef def) {
     ...
     */
    @Override
    protected QueryField<?> doSort(OrderItem orderItem, UpdateHistoryDef def) {
     ...
     */
    @Override
    protected List<DefaultOrderBy> defaultSort(UpdateHistoryDef def) {
         // 使用以下方法构建默认排序
