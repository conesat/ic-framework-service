  ...
  <div>
    <t-card class="list-card-container" :bordered="false">
      ...
      >
        <template #op="{ row }">
          <t-space>
            <t-link hover="color" theme="primary" @click="handleClickRoom(row)">查看房间</t-link>
...
const emit = defineEmits(['showRoom']);
// 定义变量 start -------------------
...
const columns: PrimaryTableCol[] = [
  ...
  {title: '楼层', colKey: 'level'},
  {title: '所属楼栋', colKey: 'buildingName'},
...
const handleClickEdit = (id?: any) => {
  router.push(`/hotel/floor-edit?autoClose=true&buildingId=${props.buildingId}&id=${id ? id : ''}`);
};
