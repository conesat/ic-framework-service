...
const columns: PrimaryTableCol[] = [
  ...
  {title: '客户-用户id', colKey: 'userId'},
  {title: '客户姓名', colKey: 'customerName'},
  {title: '客户电话', colKey: 'customerPhone'},
  {title: '房间价格', colKey: 'roomPrice'},
  {title: '实付价格', colKey: 'actualRoomPrice'},
  {title: '入住时间', colKey: 'inDate'},
  {title: '离店时间', colKey: 'outDate'},
  {title: '房间号', colKey: 'roomId'},
...
const handleClickEdit = () => {
  window.open(`#/hotel/room-order-edit?autoClose=true`);
};
// 定义方法 end -------------------
