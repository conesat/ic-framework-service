<template>
  <div>
    <t-card class="list-card-container" :bordered="false">
      ...
      >
        <template #starLevel="{ row }">
          <t-rate :value="row.starLevel" size="16px" disabled></t-rate>
        </template>
        <template #empty>
...
const columns: PrimaryTableCol[] = [
  ...
  {title: '星级', colKey: 'starLevel'},
  {title: '酒店经理', colKey: 'managerUserName'},
  {title: '地址', colKey: 'address', ellipsis: true}
];
// 定义变量 end -------------------
...
const handleClickEdit = () => {
  window.open(`#/hotel/hotel-edit?autoClose=true`);
};
// 定义方法 end -------------------
