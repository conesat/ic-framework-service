...
const columns: PrimaryTableCol[] = [
  ...
  {title: '房间id', colKey: 'roomId'},
  {title: '配套id', colKey: 'supportingId'},
  {
    align: 'left',
    fixed: 'right',
    width: 120,
...
const handleClickEdit = (id?: any) => {
  router.push(`/hotel/room-supporting-edit?id=${id ? id : ''}`);
};
// 单个删除按钮事件
