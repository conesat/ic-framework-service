...
const columns: PrimaryTableCol[] = [
  ...
  {title: '接单人员id', colKey: 'serverUserId'},
  {title: '服务状态', colKey: 'state'},
  {title: '服务类型[1=清洁][2=送货上门]', colKey: 'target'},
  {title: '服务内容id', colKey: 'targetId'},
...
const handleClickEdit = () => {
  window.open(`#/hotel/server-order-edit?autoClose=true`);
};
// 定义方法 end -------------------
