...
const columns: PrimaryTableCol[] = [
  ...
  {title: '所属用户', colKey: 'userId'},
  {title: '班次', colKey: 'timeScopeId'},
  {title: '日期', colKey: 'date'},
  {title: '是否签到', colKey: 'sign'},
];
// 定义变量 end -------------------
...
const handleClickEdit = () => {
  window.open(`#/hotel/scheduling-edit?autoClose=true`);
};
// 定义方法 end -------------------
