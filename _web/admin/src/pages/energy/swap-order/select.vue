...
const columns: PrimaryTableCol[] = [
  ...
  {title: '换电站ID', colKey: 'stationId'},
  {title: '电池ID', colKey: 'batteryId'},
  {title: '订单类型（1换电、2暂存、3租赁）', colKey: 'orderType'},
  {title: '订单状态（1进行中、2完成、3异常、4取消）', colKey: 'status'},
  {title: '实付金额', colKey: 'amount'},
  {title: '开始时间', colKey: 'startTime'},
  {title: '结束时间', colKey: 'endTime'},
...
const handleClickEdit = () => {
  window.open(`/energy/swap-order-edit?autoClose=true`);
};
// 定义方法 end -------------------
