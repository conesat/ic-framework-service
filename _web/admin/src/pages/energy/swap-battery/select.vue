...
const columns: PrimaryTableCol[] = [
  ...
  {title: '电池编号', colKey: 'batteryNo'},
  {title: '所属换电站', colKey: 'stationId'},
  {title: '电池型号', colKey: 'model'},
  {title: '电压（V）', colKey: 'voltage'},
  {title: '容量（Ah）', colKey: 'capacity'},
  {title: '当前电量（%）', colKey: 'powerPercent'},
  {title: '健康度（%）', colKey: 'healthPercent'},
  {title: '状态（1可租、2使用中、3暂存、4维修、0停用）', colKey: 'status'},
  {title: '最近换电时间', colKey: 'lastSwapTime'},
...
const handleClickEdit = () => {
  window.open(`/energy/swap-battery-edit?autoClose=true`);
};
// 定义方法 end -------------------
