...
const columns: PrimaryTableCol[] = [
  ...
  {title: '站点编号', colKey: 'stationCode'},
  {title: '站点名称', colKey: 'name'},
  {title: '城市', colKey: 'city'},
  {title: '区域', colKey: 'district'},
  {title: '详细地址', colKey: 'address'},
  {title: '经度', colKey: 'longitude'},
  {title: '纬度', colKey: 'latitude'},
  {title: '营业时间', colKey: 'businessHours'},
  {title: '联系电话', colKey: 'contactPhone'},
  {title: '营业状态（1营业中、0停用、2维护）', colKey: 'status'},
  {title: '电柜总格口数', colKey: 'totalCabinets'},
  {title: '可用电池数', colKey: 'availableBatteryCount'},
  {title: '可还空位数', colKey: 'availableReturnSlots'},
  {title: '评分', colKey: 'rating'},
  {title: '服务设施', colKey: 'facilities'},
  {title: '站点公告', colKey: 'announcement'},
...
const handleClickEdit = () => {
  window.open(`/energy/swap-station-edit?autoClose=true`);
};
// 定义方法 end -------------------
