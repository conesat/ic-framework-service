...
const columns: PrimaryTableCol[] = [
  ...
  {title: '工单编号', colKey: 'orderNo'},
  {title: '用户ID', colKey: 'userId'},
  {title: '关联站点ID', colKey: 'stationId'},
  {title: '故障类型', colKey: 'repairType'},
  {title: '问题描述', colKey: 'description'},
  {title: '图片地址', colKey: 'images'},
  {title: '联系电话', colKey: 'contactPhone'},
  {title: '状态（1待处理、2处理中、3已完成、4已取消）', colKey: 'status'},
  {title: '处理人ID', colKey: 'handlerId'},
  {title: '处理说明', colKey: 'handleRemark'},
  {title: '处理时间', colKey: 'repairTime'},
...
const handleClickEdit = () => {
  window.open(`/energy/repair-order-edit?autoClose=true`);
};
// 定义方法 end -------------------
