package cn.icframework.hotel.module.scheduling.wrapperbuilder;
 ...
 */
@Component
public class SchedulingWrapperBuilder extends BasicWrapperBuilder<SchedulingDef> {
     ...
     * 返回一个数据库定义对象
     */
    public SchedulingWrapperBuilder() {
        super(SchedulingDef.table());
    }
     ...
     */
    @Override
    protected SqlWrapper list(QueryParams params, SchedulingDef def) {
     ...
     */
    @Override
    protected QueryField<?> doSort(OrderItem orderItem, SchedulingDef def) {
     ...
     */
    @Override
    protected List<DefaultOrderBy> defaultSort(SchedulingDef def) {
        // 使用以下方法构建默认排序
