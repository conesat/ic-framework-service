package cn.icframework.hotel.module.roomtype.wrapperbuilder;
 ...
 */
@Component
public class RoomTypeWrapperBuilder extends BasicWrapperBuilder<RoomTypeDef> {

    /**
    * 返回一个数据库定义对象
    */
    public RoomTypeWrapperBuilder() {
        super(RoomTypeDef.table());
    }
     ...
     */
    @Override
    protected SqlWrapper list(QueryParams params, RoomTypeDef def) {
     ...
     */
    @Override
    protected QueryField<?> doSort(OrderItem orderItem, RoomTypeDef def) {
     ...
     */
    @Override
    protected List<DefaultOrderBy> defaultSort(RoomTypeDef def) {
         // 使用以下方法构建默认排序
