package cn.icframework.hotel.module.roompic.wrapperbuilder;
 ...
 */
@Component
public class RoomPicWrapperBuilder extends BasicWrapperBuilder<RoomPicDef> {

    /**
    * 返回一个数据库定义对象
    */
    public RoomPicWrapperBuilder() {
        super(RoomPicDef.table());
    }
     ...
     */
    @Override
    protected SqlWrapper list(QueryParams params, RoomPicDef def) {
     ...
     */
    @Override
    protected QueryField<?> doSort(OrderItem orderItem, RoomPicDef def) {
     ...
     */
    @Override
    protected List<DefaultOrderBy> defaultSort(RoomPicDef def) {
         // 使用以下方法构建默认排序
