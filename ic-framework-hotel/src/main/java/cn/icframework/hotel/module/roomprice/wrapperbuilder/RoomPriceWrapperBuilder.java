package cn.icframework.hotel.module.roomprice.wrapperbuilder;
 ...
 */
@Component
public class RoomPriceWrapperBuilder extends BasicWrapperBuilder<RoomPriceDef> {

    /**
    * 返回一个数据库定义对象
    */
    public RoomPriceWrapperBuilder() {
        super(RoomPriceDef.table());
    }
     ...
     */
    @Override
    protected SqlWrapper list(QueryParams params, RoomPriceDef def) {
     ...
     */
    @Override
    protected QueryField<?> doSort(OrderItem orderItem, RoomPriceDef def) {
     ...
     */
    @Override
    protected List<DefaultOrderBy> defaultSort(RoomPriceDef def) {
         // 使用以下方法构建默认排序
